...
#include <stdexcept> // Include errors
#include <bits/stdc++.h> // INT_MAX and/or INT_MIN
...
bool SmarterSection(int A_correct, int A_total, int B_correct, int B_total) noexcept(false);
